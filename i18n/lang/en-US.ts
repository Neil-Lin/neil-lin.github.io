export default {
  ...
  page: {
    ...
    sitemap: {
      p1: "This website is built based on the principles of accessible web design. The layout of the website is divided into three major sections.{0}{0}1. header 2. main content 3. footer{0}{0}The Accesskey settings for this website are as follows: ",
      p2: "{keyU}：header, main menu, including switch language&copyright{n}{keyC}：main content{n}{keyZ}：footer, including switch language&copyright{n}",

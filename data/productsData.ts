...
export const productsData: Product[] = [
  {
    ...
    name: {
      "zh-Hant-TW": "Piman 無障礙 UI 框架",
      en: "Piman A11Y UI Framework",
    },
    intro: {
      "zh-Hant-TW":
    ...
    target: {
      ...
      en: [
        "Achieving universal design for web pages.",
        "Open Source",
        "Design System",
      ],
    },
    ...
    tools: {
      "zh-Hant-TW": ["Figma", "Github", "npm", "Notion"],
      en: ["Figma", "Github", "npm", "Notion"],
    },
    observe: {
      "zh-Hant-TW": [
        "IBM Carbon",
      ...
      en: ["IBM Carbon", "Bootstrap 5", "Vital Ui Kit", "Material Design 3"],
    },
    learn: {
      "zh-Hant-TW": [
        "以前只是為了通過無障礙網頁設計標章，透過此專案專研無障礙網頁知識與技術",
        "開源軟體前、後所需要具備的知識",
        "如何從無障礙網頁設計技巧擴大到網頁的「通用設計」的觀念",
      ],
      en: [
        "Through this project, we aim to delve deeper into the knowledge and techniques of accessible web design.",
        "The knowledge required for development of open-source software.",
        "Universal Design",
      ],
    },
    output: {
    ...
    images: {
      "zh-Hant-TW": [
        {
          src: "/images/piman-v3-design-system.webp",
          figcaption: "Piman V3 後台範本",
        },
        {
          src: "/images/piman-v3-button.webp",
          figcaption: "Piman V3 按鈕元件",
        },
        {
          src: "/images/piman-v3-backstage-template.webp",
          figcaption: "Piman V3 設計系統",
        },
      ],
      en: [
        {
          src: "/images/piman-v3-design-system.webp",
          figcaption: "Piman V3 Baclstage Template",
        },
        {
          src: "/images/piman-v3-button.webp",
          figcaption: "Piman V3 Button",
        },
        {
          src: "/images/piman-v3-backstage-template.webp",
          figcaption: "Piman V3 Design System",
        },
      ],
    },
    relatedLinks: {
      "zh-Hant-TW": [
        {
          title: "Piman Github",
          link: "https://github.com/ya-sai/piman",
        },
        {
          title: "Piman V3 Github",
          link: "https://github.com/BPbase/piman",
        },
        {
          title: "Piman V3 試玩(後台範本與元件)",
          link: "https://bpbase.github.io/piman/demo/#/",
        },
        {
          title: "Piman 官方網站",
          link: "https://bpio.gitbook.io/piman",
        },
        {
          title: "Piman 設計系統 Figma",
          link: "https://www.figma.com/community/file/1182586164850970870",
        },
        {
          title: "Piman v3 後台系統範本",
          link: "https://www.figma.com/community/file/1210126707767575165",
        },
        {
        ...
        {
          title: "Vital UI Kit",
          link: "https://vitaluikit.com/",
        },
        {
          title: "開源軟體指南",
          link: "https://opensource.guide/zh-hant/",
        },
        {
          title: "無障礙網路空間服務網",
          link: "https://accessibility.moda.gov.tw/",
        },
      ],
      en: [
        {
          title: "Piman V2 Github",
          link: "https://github.com/ya-sai/piman",
        },
        {
          title: "Piman V3 Github",
        ...
        {
          title: "Piman V3 Demo(Backstage and Components)",
          link: "https://bpbase.github.io/piman/demo/#/",
        },
        {
          title: "Piman Official Website",
          link: "https://bpio.gitbook.io/piman",
        },
        {
          title: "Piman Design System Community",
          link: "https://www.figma.com/community/file/1182586164850970870",
        },
        {
          title: "Piman Backstage Template",
          link: "https://www.figma.com/community/file/1210126707767575165",
        },
        {
          title: "Material Design 3",
  ...
  },
  {
    ...
    summary: {
      ...
      en: "Choose is an all-encompassing tool that aggregates vast amounts of news and social media data to become your most helpful assistant. It assists you in observing key trends related to specific topics, generating concepts for events and campaigns, and handling PR crises in real-time. It is designed for PR professionals, marketers, brand consultants, media agencies, and advertising agencies, providing comprehensive support for their needs.This article solely introduces the data visualization of Choose.",
    },
    platform: ["web"],
    ...
    target: {
      ...
      en: [
        "Quickly grasp the relevance of target content and five dimensions.",
        "Quickly grasp the relevance between the five dimensions and target content.",
        "Quickly grasp the relevance among different project contents.",
    ...
    learn: {
      ...
      en: [
        ...
        "What content does the target data include?",
        "Observe and analyze competitive charts.",
      ],
    },
    output: {
      "zh-Hant-TW": [
      ...
      en: [
        "Hot keyword influence diagnosis chart",
        "Comparison Chart",
        "Term extraction diagram.",
      ],
    },
    images: {
      "zh-Hant-TW": [
        ...
        },
        {
          ...
          figcaption: "熱詞影響力診斷圖-目標相關性",
        },
        {
          src: "/images/choose-chart-hotkeywords-detail.webp",
          figcaption: "熱詞影響力診斷圖-分類",
        },
        {
          src: "/images/choose-chart-hotkeywords-detail-hover.webp",
          figcaption: "熱詞影響力診斷圖-分類項目相關性",
        },
      ],
      en: [
        {
          src: "/images/choose-chart-hotkeywords.webp",
          figcaption: "Hot keyword influence diagnosis chart",
        },
        {
          src: "/images/choose-chart-hotkeywords-hover.webp",
          figcaption: "Hot keyword influence diagnosis chart - related",
        },
        {
          src: "/images/choose-chart-hotkeywords-detail.webp",
          figcaption: "Hot keyword influence diagnosis chart - category",
        },
        {
          src: "/images/choose-chart-hotkeywords-detail-hover.webp",
          figcaption: "Hot keyword influence diagnosis chart - items",
        },
      ],
    },
    relatedLinks: {
      "zh-Hant-TW": [
        {
          title: "蛛思介紹頁",
          link: "https://choose.blueplanet.com.tw/intro/",
        },
        {
          title: "蛛思蛛思熱詞影響力診斷體驗 ",
          link: "https://choose.blueplanet.com.tw/lab",
        },
      ],
      en: [
        {
  ...
  },
  {
    ...
    summary: {
      ...
      en: "ΣCOUT is the first commercial resume search service in Taiwan. It combines a variety of OPENDATA and integrates various unstructured business data from the internet, allowing users to quickly grasp the business performance of companies across Taiwan. It is widely used for business credit inquiries and commercial credit assessments, significantly improving the efficiency of data collection and verification processes while reducing time and labor costs. It helps quickly detect information about business partners, competitors, or lending targets, and reveals business operations facts through credible data sets.",
    },
    platform: ["web"],
    ...
    target: {
      "zh-Hant-TW": [
        ...
        "設定產品個性",
        "企業搜尋界的 Google",
        "資料視覺化圖表(實質受益人、股權結構表、一般圖表)",
      ],
      en: [
        'Establishing the "company resume" image.',
        "Defining product personality.",
        "Becoming the Google of corporate search.",
        "Data visualization charts (beneficial owners, equity structure charts, general charts).",
      ],
    },
    roles: {
      "zh-Hant-TW": ["UI", "切版"],
    ...
    observe: {
      "zh-Hant-TW": ["104", "CakeResume", "Yourator", "Wanted", "企查查"],
      en: ["104", "CakeResume", "Yourator", "Wanted", "企查查"],
    },
    learn: {
      "zh-Hant-TW": [
        "什麼是 KYC？",
      ...
      en: [
        "What is KYC?",
        "What are business credit inquiries and commercial credit assessments?",
        "Who needs to search for company information?",
      ],
    },
    output: {
      "zh-Hant-TW": [
        "資料視覺化圖示獲得五項合計設計與發明專利（也同時獲取美國專利）",
        "（系統畫面與資訊視覺化圖表不適合公開，僅展示部分特色畫面）",
        "Landing Page(多顏色主題)",
        "404 page",
      ],
      en: [
        "The data visualization icon has obtained a total of five design and invention patents (including a U.S. patent).",
        "The system interface and information visualization charts are not suitable for public display, only selected featured screens are shown",
    ...
    images: {
      "zh-Hant-TW": [
        {
          ...
          figcaption: "Landing Page(明亮模式)",
        },
        {
          src: "/images/scout-landingpage-dark.webp",
          figcaption: "Landing Page(黑暗模式)",
        },
        {
      ...
      en: [
        {
          src: "/images/scout-landingpage-light.webp",
          figcaption: "Landing Page(Light Mode)",
        },
        {
          src: "/images/scout-landingpage-dark.webp",
          figcaption: "Landing Page(Dark Mode)",
        },
        {
          src: "/images/scout-404.webp",
          figcaption: "404 page",
    ...
    relatedLinks: {
      "zh-Hant-TW": [
        {
          title: "ΣCOUT 實告 Landing Page",
          link: "https://scout.blueplanet.com.tw/",
        },
      ],
      en: [
        {
          title: "ΣCOUT Landing Page",
          link: "https://scout.blueplanet.com.tw/",
        },
      ],
    },
  ...
  },
  {
    ...
    name: {
      "zh-Hant-TW": "Vital CRM 客戶關係管理系統新版（僅 Wireframe）",
      en: "Vital CRM（Wireframe）",
    },
    intro: {
      "zh-Hant-TW": "設計新版",
      en: "New Version",
  ...
  },
  {
    ...
    target: {
      ...
      en: [
        ...
        "A Taiwan-based Open-Source UI Kit",
        "Bridging the Gap Between Engineers and Designers",
      ],
    },
    roles: {
      "zh-Hant-TW": ["UX", "切版"],
    ...
    tools: {
      "zh-Hant-TW": ["Sketch app", "Fabricator"],
      en: ["Sketch app", "Fabricator"],
    },
    observe: {
      "zh-Hant-TW": [
        "jQuery UI",
    ...
    learn: {
      ...
      en: [
        ...
        "What are the competing products?",
        "Who will use it?",
        "Why is there no open-source UI Kit in Taiwan?",
      ],
    },
    research: {
      "zh-Hant-TW": [
        "研究前述各大前端 UI 框架設計稿與切版如何搭配。",
        "研研究 Sketch App 設計稿管理與協作規則制定，例如參數設定等。",
        "研究 CSS 管理與命名規則。",
        "研究融合 設計稿 與 CSS 命名規則，方便一眼便知是哪個元件。",
        "研究以何種方式建立 Document 網站內容。",
        "研究LandingPage 文案、個性朔造。",
      ],
      en: [
        "Research how major front-end UI frameworks integrate design drafts with implementation.",
        "Study Sketch App's design draft management and collaboration guidelines, including parameter settings.",
        "Research CSS management and naming conventions.",
        "Explore how to integrate design drafts with CSS naming conventions for easy component identification.",
        "Examine the best approach to building a documentation website.",
        "Research landing page copywriting and brand personality development.",
      ],
    },
    images: {
      "zh-Hant-TW": [
        {
          ...
          figcaption: "使用 Fabricator 建立文件",
        },
        {
          src: "/images/vitaluikit-sketch.webp",
          figcaption: "Sketch App 檔案 Button 元件示意圖",
        },
      ],
      en: [
        {
          src: "/images/vitaluikit-docs.webp",
          figcaption: "Create Documents by Fabricator",
        },
        {
          src: "/images/vitaluikit-sketch.webp",
          figcaption: "Sketch App - Button",
        },
      ],
    },
    relatedLinks: {
    ...
    images: {
      "zh-Hant-TW": [
        ...
        },
        {
          ...
          figcaption:
            "藉由 Wireframe 密集討論，找出最符合情境、最有效率的方案。",
        },
        {
  ...
  },
  {
    ...
    name: {
      "zh-Hant-TW": "[Side Project] DahTahDoc",
      en: "[Side Project] DahTahDoc",
    },
    intro: {
      "zh-Hant-TW": "專為文件協作溝通效率而生",
      en: "Built for document collaboration and communication efficiency.",
    },
    keywords: {
      "zh-Hant-TW": [
        "知識管理",
    ...
    summary: {
      "zh-Hant-TW":
        "專為溝通文件而生。透過簡單的自動雙向錨點技術，將需求文件、技術文件、設計稿、參考連結和相關檔案緊密串聯，建立高效的協作流程。",
      en: "Built for document collaboration and communication efficiency. Through simple automatic bidirectional linking technology, it tightly connects requirements documents, technical documents, design drafts, reference links, and related files to establish an efficient collaboration workflow.",
    },
    platform: ["web"],
    yearRange: { start: 2026, end: null },
    target: {
      "zh-Hant-TW": [
        "讓文件協作更有效率",
        "讓需求文件、技術文件、設計稿、參考連結和相關檔案緊密串聯",
      ],
      en: [
        "Make document collaboration more efficient",
        "Enable requirements documents, technical documents, design drafts, reference links, and related files to be tightly connected",
      ],
    },
    roles: {
      "zh-Hant-TW": ["UI", "UX", "切版", "專案管理", "Vibe Coding"],
    ...
    research: {
      ...
      en: [
        "Breaking Down Document Creation, Collaboration, and Sharing Process",
        "Identifying Various Pain Points Faced by Users and Developers in the Process",
        "How to Use LLM to Generate Consistent Results",
      ],
    },
    images: {
      "zh-Hant-TW": [
